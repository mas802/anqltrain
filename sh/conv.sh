...
magick "${SRC_IMG_DIR}/xmas2023_ - 2.jpeg" -resize 300x ${IMG_DIR}/HOUSE_OFF.jpg
common_pics HOUSE

# magick "${SRC_IMG_DIR}/xmas2023_ - 8.jpeg" -resize 300x -crop 300x225+0+20 ${IMG_DIR}/TRACK_ON.jpg
# magick "${SRC_IMG_DIR}/xmas2023_ - 7.jpeg" -resize 300x -crop 300x225+0+20 -modulate 100,50 ${IMG_DIR}/TRACK_OFF.jpg
# common_pics TRACK

magick ${SRC_IMG_DIR}/IMG_1018.jpg -resize 300x -crop 300x225+0+20 ${IMG_DIR}/TRACK_ON.jpg
magick ${SRC_IMG_DIR}/IMG_1018.jpg -resize 300x -crop 300x225+0+20 -modulate 100,50 ${IMG_DIR}/TRACK_OFF.jpg
common_pics TRACK
...
magick "${SRC_IMG_DIR}/IMG_6968.jpeg" -resize 300x  -crop 300x225+0+140  ${IMG_DIR}/FIRE_ON.jpg
magick "${SRC_IMG_DIR}/IMG_6971.jpeg" -resize 300x  -crop 300x225+0+140  ${IMG_DIR}/FIRE_OFF.jpg
common_pics FIRE

magick "${SRC_IMG_DIR}/107_1412/IMGP0958.JPG" -resize x225 -crop 300x225+0+0 ${IMG_DIR}/DRAGON_ON.jpg
magick "${SRC_IMG_DIR}/107_1412/IMGP0959.JPG" -resize x225 -crop 300x225+0+0 ${IMG_DIR}/DRAGON_OFF.jpg
common_pics DRAGON

magick "${SRC_IMG_DIR}/xmas2023_ - 11.jpeg" -resize x225 -crop 300x225+0+0 ${IMG_DIR}/CONVEYOR_ON.jpg
magick "${SRC_IMG_DIR}/xmas2023_ - 11.jpeg" -resize x225 -crop 300x225+0+0 -modulate 100,50 ${IMG_DIR}/CONVEYOR_OFF.jpg
common_pics CONVEYOR

magick "${SRC_IMG_DIR}/IMG_6941.jpeg" -resize x325 -crop 300x225+100+30 ${IMG_DIR}/GUGGE_ON.jpg
magick "${SRC_IMG_DIR}/IMG_6941.jpeg" -resize x325 -crop 300x225+100+30 -modulate 100,50 ${IMG_DIR}/GUGGE_OFF.jpg
common_pics GUGGE

magick "${SRC_IMG_DIR}/IMG_6947.jpeg" -resize x425 -crop 300x225+0+0 ${IMG_DIR}/CROSSING_ON.jpg
magick ${IMG_DIR}/CROSSING_ON.jpg -modulate 100,50 ${IMG_DIR}/CROSSING_OFF.jpg
common_pics CROSSING

magick "${SRC_IMG_DIR}/107_1412/IMGP0967.JPG" -resize x300 -crop 225x300+150+0 ${IMG_DIR}/SANTA_ON.jpg
magick ${IMG_DIR}/SANTA_ON.jpg -modulate 100,50 ${IMG_DIR}/SANTA_OFF.jpg
common_pics SANTA

magick "${SRC_IMG_DIR}/IMG_6978.jpeg" -resize x225 -crop 300x225+0+0 ${IMG_DIR}/GHOSTBUSTERS_ON.jpg
magick ${IMG_DIR}/GHOSTBUSTERS_ON.jpg -modulate 100,50 ${IMG_DIR}/GHOSTBUSTERS_OFF.jpg
common_pics GHOSTBUSTERS

magick "${SRC_IMG_DIR}/xmas2023_ - 4.jpeg" -resize 300x  -crop 300x225+0+0 ${IMG_DIR}/CAVE_ON.jpg
magick "${SRC_IMG_DIR}/xmas2023_ - 3.jpeg" -resize 300x  -crop 300x225+0+0 ${IMG_DIR}/CAVE_OFF.jpg
common_pics CAVE

magick ${SRC_IMG_DIR}/IMG_9503.jpg -resize 300x -crop 300x225+0+70 ${IMG_DIR}/SIGNAL1_ON.jpg
magick ${SRC_IMG_DIR}/IMG_9502.jpg -resize 300x -crop 300x225+0+70 ${IMG_DIR}/SIGNAL1_OFF.jpg
common_pics SIGNAL1

magick ${SRC_IMG_DIR}/IMG_9508.jpg -resize 300x -crop 300x225+0+70 ${IMG_DIR}/SIGNAL2_ON.jpg
magick ${SRC_IMG_DIR}/IMG_9507.jpg -resize 300x -crop 300x225+0+70 ${IMG_DIR}/SIGNAL2_OFF.jpg
common_pics SIGNAL2

magick ${SRC_IMG_DIR}/IMG_9517.jpg -resize 300x -crop 300x225+0+70 ${IMG_DIR}/SIGNAL3_ON.jpg
magick ${SRC_IMG_DIR}/IMG_9518.jpg -resize 300x -crop 300x225+0+70 ${IMG_DIR}/SIGNAL3_OFF.jpg
common_pics SIGNAL3

magick ${SRC_IMG_DIR}/IMG_9509.jpg -resize 300x -crop 300x225+0+100 ${IMG_DIR}/WHITE1_ON.jpg
magick ${SRC_IMG_DIR}/IMG_9510.jpg -resize 300x -crop 300x225+0+100 ${IMG_DIR}/WHITE1_OFF.jpg
common_pics WHITE1

magick ${SRC_IMG_DIR}/IMG_9499.jpg -resize 300x -crop 300x225+0+100 ${IMG_DIR}/WHITE2_ON.jpg
magick ${SRC_IMG_DIR}/IMG_9500.jpg -resize 300x -crop 300x225+0+100 ${IMG_DIR}/WHITE2_OFF.jpg
common_pics WHITE2

magick ${SRC_IMG_DIR}/IMG_9474.jpg -resize x225 -crop 300x225+0+120 ${IMG_DIR}/WARN_ON.jpg
...
magick ${SRC_IMG_DIR}/IMG_9510.jpg -resize 300x -crop 300x225+0+80 ${IMG_DIR}/DECOUPLERFRONT_OFF.jpg
common_pics DECOUPLERFRONT

magick ${SRC_IMG_DIR}/IMG_3464.jpg -resize 300x -crop 300x225+0+0 ${IMG_DIR}/BLUE_ON.jpg
magick ${SRC_IMG_DIR}/IMG_3464.jpg -resize 300x -crop 300x225+0+0 ${IMG_DIR}/BLUE_OFF.jpg
common_pics BLUE

magick ${SRC_IMG_DIR}/IMG_3462.jpg -resize x225 -crop 300x225+0+0 ${IMG_DIR}/RED_ON.jpg
magick ${SRC_IMG_DIR}/IMG_3462.jpg -resize x225 -crop 300x225+0+0 ${IMG_DIR}/RED_OFF.jpg
common_pics RED

magick ${SRC_IMG_DIR}/IMG_3463.jpg -resize 300x -crop 300x225+0+0 ${IMG_DIR}/GREEN_ON.jpg
magick ${SRC_IMG_DIR}/IMG_3463.jpg -resize 300x -crop 300x225+0+0 ${IMG_DIR}/GREEN_OFF.jpg
common_pics GREEN

magick ${SRC_IMG_DIR}/dark.jpg -resize x225 -crop 300x225+0+0 ${IMG_DIR}/ALLOFF_ON.jpg
magick ${SRC_IMG_DIR}/dark.jpg -resize x225 -crop 300x225+0+0 ${IMG_DIR}/ALLOFF_OFF.jpg
common_pics ALLOFF

magick ${SRC_IMG_DIR}/light.jpg -resize x225 -crop 300x225+0+0 ${IMG_DIR}/ALLON_ON.jpg
magick ${SRC_IMG_DIR}/light.jpg -resize x225 -crop 300x225+0+0 ${IMG_DIR}/ALLON_OFF.jpg
common_pics ALLON

magick -size 300x225 xc:purple ${IMG_DIR}/PURPLE_ON.jpg
magick -size 300x225 xc:purple ${IMG_DIR}/PURPLE_OFF.jpg
common_pics PURPLE

magick -size 300x225 xc:#822 ${IMG_DIR}/NONE_ON.jpg
magick -size 300x225 xc:#822 ${IMG_DIR}/NONE_OFF.jpg
magick -size 300x225 xc:#822 ${IMG_DIR}/NONE_load.jpg
magick -size 300x225 xc:#822 ${IMG_DIR}/NONE_error.jpg
magick -size 300x225 xc:#822 ${IMG_DIR}/NONE_failed.jpg
